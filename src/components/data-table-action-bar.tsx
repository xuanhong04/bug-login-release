    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className={cn(
            "fixed right-6 bottom-6 z-50 flex max-w-[calc(100%-3rem)] flex-wrap items-center justify-end gap-2 rounded-md border bg-background p-2 text-foreground shadow-sm",
            className,
          )}
          {...props}
        >
